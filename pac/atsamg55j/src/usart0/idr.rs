...
#[doc = "Field `ENDRX` writer - End of Receive Buffer Interrupt Enable (available in all USART modes of operation)"]
...
#[doc = "Field `ENDTX` writer - End of Transmit Buffer Interrupt Disable (available in all USART modes of operation)"]
...
#[doc = "Field `TXBUFE` writer - Transmit Buffer Empty Interrupt Enable (available in all USART modes of operation)"]
...
#[doc = "Field `RXBUFF` writer - Receive Buffer Full Interrupt Enable (available in all USART modes of operation)"]
