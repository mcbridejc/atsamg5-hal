...
#[doc = "Field `LCCHG` writer - Last Channel Change Interrupt Disable"]
pub struct LCCHG_W<'a> {
    w: &'a mut W,
}
impl<'a> LCCHG_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[doc = "Bit 19 - Last Channel Change Interrupt Disable"]
    #[inline(always)]
    pub fn lcchg(&mut self) -> LCCHG_W {
        LCCHG_W { w: self }
    }
