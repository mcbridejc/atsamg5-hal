...
pub struct CHNBOSR_R(crate::FieldReader<u8, u8>);
impl CHNBOSR_R {
    pub(crate) fn new(bits: u8) -> Self {
        CHNBOSR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CHNBOSR_R {
...
impl R {
    ...
    #[inline(always)]
    pub fn chnbosr(&self) -> CHNBOSR_R {
        CHNBOSR_R::new(((self.bits >> 24) & 0x1f) as u8)
    }
}
