...
#[repr(u8)]
pub enum TRGSEL_A {
    #[doc = "0: ADTRG External trigger"]
    ADC_TRIG0 = 0,
    #[doc = "1: TIOA0 Output of the Timer Counter Channel 0"]
    ADC_TRIG1 = 1,
    #[doc = "2: TIOA1 Output of the Timer Counter Channel 1"]
    ADC_TRIG2 = 2,
    #[doc = "3: TIOA2 Output of the Timer Counter Channel 2"]
    ADC_TRIG3 = 3,
    #[doc = "4: RTCOUT0"]
    ADC_TRIG4 = 4,
    #[doc = "5: RTT 16-Bit prescaler output"]
    ADC_TRIG5 = 5,
    #[doc = "6: RTTEVENT"]
    ADC_TRIG6 = 6,
    #[doc = "7: -"]
...
impl TRGSEL_R {
    ...
    pub fn variant(&self) -> TRGSEL_A {
        match self.bits {
            0 => TRGSEL_A::ADC_TRIG0,
            1 => TRGSEL_A::ADC_TRIG1,
            2 => TRGSEL_A::ADC_TRIG2,
            3 => TRGSEL_A::ADC_TRIG3,
            4 => TRGSEL_A::ADC_TRIG4,
            5 => TRGSEL_A::ADC_TRIG5,
            6 => TRGSEL_A::ADC_TRIG6,
            7 => TRGSEL_A::ADC_TRIG7,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `ADC_TRIG6`"]
    #[inline(always)]
    pub fn is_adc_trig6(&self) -> bool {
        **self == TRGSEL_A::ADC_TRIG6
    }
    #[doc = "Checks if the value of the field is `ADC_TRIG7`"]
    #[inline(always)]
    pub fn is_adc_trig7(&self) -> bool {
        **self == TRGSEL_A::ADC_TRIG7
    }
}
...
impl<'a> TRGSEL_W<'a> {
    ...
    #[doc = "RTT 16-Bit prescaler output"]
    #[inline(always)]
    ...
    #[doc = "RTTEVENT"]
    #[inline(always)]
    pub fn adc_trig6(self) -> &'a mut W {
        self.variant(TRGSEL_A::ADC_TRIG6)
    }
    #[doc = "-"]
    #[inline(always)]
    pub fn adc_trig7(self) -> &'a mut W {
        self.variant(TRGSEL_A::ADC_TRIG7)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ANACH_A {
    #[doc = "0: No analog change on channel switching: DIFF0, and OFF0 are used for all channels."]
    NONE = 0,
    #[doc = "1: Allows different analog settings for each channel. See ADC_COR registers."]
    ALLOWED = 1,
}
...
impl<'a> ANACH_W<'a> {
    ...
    #[doc = "No analog change on channel switching: DIFF0, and OFF0 are used for all channels."]
    #[inline(always)]
    pub fn none(self) -> &'a mut W {
        self.variant(ANACH_A::NONE)
    }
    #[doc = "Allows different analog settings for each channel. See ADC_COR registers."]
    #[inline(always)]
...
pub enum USEQ_A {
    ...
    NUM_ORDER = 0,
    #[doc = "1: User Sequence Mode: The sequence respects what is defined in ADC_SEQR1 register and can be used to convert the same channel several times."]
    REG_ORDER = 1,
}
...
impl<'a> USEQ_W<'a> {
    ...
    #[doc = "User Sequence Mode: The sequence respects what is defined in ADC_SEQR1 register and can be used to convert the same channel several times."]
    #[inline(always)]
