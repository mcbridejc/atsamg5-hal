...
#[repr(u8)]
pub enum MOSCRCF_A {
    #[doc = "0: The fast RC oscillator frequency is at 8 MHz (default)"]
    _8_MHZ = 0,
    #[doc = "1: The fast RC oscillator frequency is at 16 MHz"]
    _16_MHZ = 1,
    #[doc = "2: The fast RC oscillator frequency is at 24 MHz"]
    _24_MHZ = 2,
}
...
impl MOSCRCF_R {
    ...
    pub fn variant(&self) -> Option<MOSCRCF_A> {
        match self.bits {
            0 => Some(MOSCRCF_A::_8_MHZ),
            1 => Some(MOSCRCF_A::_16_MHZ),
            2 => Some(MOSCRCF_A::_24_MHZ),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `_16_MHZ`"]
    #[inline(always)]
    pub fn is_16_mhz(&self) -> bool {
        **self == MOSCRCF_A::_16_MHZ
    }
    #[doc = "Checks if the value of the field is `_24_MHZ`"]
    #[inline(always)]
    pub fn is_24_mhz(&self) -> bool {
        **self == MOSCRCF_A::_24_MHZ
    }
}
...
impl<'a> MOSCRCF_W<'a> {
    ...
    #[doc = "The fast RC oscillator frequency is at 8 MHz (default)"]
    #[inline(always)]
    pub fn _8_mhz(self) -> &'a mut W {
        self.variant(MOSCRCF_A::_8_MHZ)
    }
    #[doc = "The fast RC oscillator frequency is at 16 MHz"]
    #[inline(always)]
    pub fn _16_mhz(self) -> &'a mut W {
        self.variant(MOSCRCF_A::_16_MHZ)
    }
    #[doc = "The fast RC oscillator frequency is at 24 MHz"]
    #[inline(always)]
    pub fn _24_mhz(self) -> &'a mut W {
        self.variant(MOSCRCF_A::_24_MHZ)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
