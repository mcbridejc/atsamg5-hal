...
pub struct PLLB_MMAX_R(crate::FieldReader<u16, u16>);
impl PLLB_MMAX_R {
    pub(crate) fn new(bits: u16) -> Self {
        PLLB_MMAX_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLB_MMAX_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct PLLB_MMAX_W<'a> {
    w: &'a mut W,
}
impl<'a> PLLB_MMAX_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl R {
    ...
    #[inline(always)]
    pub fn pllb_mmax(&self) -> PLLB_MMAX_R {
        PLLB_MMAX_R::new(((self.bits >> 16) & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - PLLA Maximum Allowed Multiplier Value"]
    ...
    #[doc = "Bits 16:26 - PLLB Maximum Allowed Multiplier Value"]
    #[inline(always)]
    pub fn pllb_mmax(&mut self) -> PLLB_MMAX_W {
        PLLB_MMAX_W { w: self }
    }
