...
#[doc = "Field `PLLAEN` reader - PLLA Control"]
pub struct PLLAEN_R(crate::FieldReader<u8, u8>);
impl PLLAEN_R {
    pub(crate) fn new(bits: u8) -> Self {
        PLLAEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PLLAEN_R {
...
#[doc = "Field `PLLAEN` writer - PLLA Control"]
pub struct PLLAEN_W<'a> {
    w: &'a mut W,
}
impl<'a> PLLAEN_W<'a> {
...
impl R {
    #[doc = "Bits 0:7 - PLLA Control"]
    #[inline(always)]
    pub fn pllaen(&self) -> PLLAEN_R {
        PLLAEN_R::new((self.bits & 0xff) as u8)
    }
    ...
    #[doc = "Bits 16:28 - PLLA Multiplier"]
    #[inline(always)]
    pub fn mula(&self) -> MULA_R {
        MULA_R::new(((self.bits >> 16) & 0x1fff) as u16)
    }
...
impl W {
    #[doc = "Bits 0:7 - PLLA Control"]
    #[inline(always)]
    pub fn pllaen(&mut self) -> PLLAEN_W {
        PLLAEN_W { w: self }
    }
    #[doc = "Bits 8:13 - PLLA Counter"]
    #[inline(always)]
