...
pub enum DIV_A {
    ...
    PERIPH_DIV4_MCK = 2,
    #[doc = "3: Peripheral clock is MCK/8"]
    PERIPH_DIV8_MCK = 3,
}
...
impl DIV_R {
    ...
    pub fn variant(&self) -> DIV_A {
        match self.bits {
            0 => DIV_A::PERIPH_DIV_MCK,
            1 => DIV_A::PERIPH_DIV2_MCK,
            2 => DIV_A::PERIPH_DIV4_MCK,
            3 => DIV_A::PERIPH_DIV8_MCK,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PERIPH_DIV8_MCK`"]
    #[inline(always)]
    pub fn is_periph_div8_mck(&self) -> bool {
        **self == DIV_A::PERIPH_DIV8_MCK
    }
}
...
impl<'a> DIV_W<'a> {
    ...
    #[doc = "Peripheral clock is MCK/8"]
    #[inline(always)]
    pub fn periph_div8_mck(self) -> &'a mut W {
        self.variant(DIV_A::PERIPH_DIV8_MCK)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
