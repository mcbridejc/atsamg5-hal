...
pub struct SCKSW_R(crate::FieldReader<bool, bool>);
impl SCKSW_R {
    pub(crate) fn new(bits: bool) -> Self {
        SCKSW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCKSW_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[inline(always)]
    pub fn scksw(&self) -> SCKSW_R {
        SCKSW_R::new(((self.bits >> 1) & 0x01) != 0)
    }
