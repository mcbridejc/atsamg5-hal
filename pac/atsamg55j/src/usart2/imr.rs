...
#[doc = "Field `ENDRX` reader - End of Receive Buffer Interrupt Mask (available in all USART modes of operation)"]
...
#[doc = "Field `ENDTX` reader - End of Transmit Buffer Interrupt Mask (available in all USART modes of operation)"]
...
#[doc = "Field `TXBUFE` reader - Transmit Buffer Empty Interrupt Mask (available in all USART modes of operation)"]
...
#[doc = "Field `RXBUFF` reader - Receive Buffer Full Interrupt Mask (available in all USART modes of operation)"]
