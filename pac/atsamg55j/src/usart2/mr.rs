...
pub enum NBSTOP_A {
    #[doc = "0: 1 stop bit"]
    _1_BIT = 0,
    #[doc = "1: 1.5 stop bits (SYNC = 0) or reserved (SYNC = 1)"]
    _1_5_BIT = 1,
    #[doc = "2: 2 stop bits"]
    _2_BIT = 2,
}
...
impl<'a> NBSTOP_W<'a> {
    ...
    #[doc = "1.5 stop bits (SYNC = 0) or reserved (SYNC = 1)"]
    #[inline(always)]
