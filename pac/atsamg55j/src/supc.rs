...
pub struct RegisterBlock {
    ...
    _reserved6: [u8; 0x04],
    #[doc = "0x1c - Supply Controller Power Mode Register"]
    pub pwmr: crate::Reg<pwmr::PWMR_SPEC>,
}
...
pub mod sr;
#[doc = "PWMR register accessor: an alias for `Reg<PWMR_SPEC>`"]
pub type PWMR = crate::Reg<pwmr::PWMR_SPEC>;
