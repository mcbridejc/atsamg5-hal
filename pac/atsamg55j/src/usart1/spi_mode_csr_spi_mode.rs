...
#[doc = "Field `UNRE` reader - Underrun Error (cleared by writing a one to the bit US_CR.RSTSTA)"]
...
#[doc = "Field `CMP` reader - Comparison Match (cleared by writing a one to the bit US_CR.RSTSTA)"]
...
impl R {
    ...
    #[doc = "Bit 10 - Underrun Error (cleared by writing a one to the bit US_CR.RSTSTA)"]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - Comparison Match (cleared by writing a one to the bit US_CR.RSTSTA)"]
    #[inline(always)]
