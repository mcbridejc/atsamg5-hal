...
#[doc = "Field `INC2AEN` reader - RTTINC2 Alarm Enable"]
pub struct INC2AEN_R(crate::FieldReader<bool, bool>);
impl INC2AEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        INC2AEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for INC2AEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `INC2AEN` writer - RTTINC2 Alarm Enable"]
pub struct INC2AEN_W<'a> {
    w: &'a mut W,
}
impl<'a> INC2AEN_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Field `EVAEN` reader - Trigger Event Alarm Enable"]
pub struct EVAEN_R(crate::FieldReader<bool, bool>);
impl EVAEN_R {
    pub(crate) fn new(bits: bool) -> Self {
        EVAEN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EVAEN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `EVAEN` writer - Trigger Event Alarm Enable"]
pub struct EVAEN_W<'a> {
    w: &'a mut W,
}
impl<'a> EVAEN_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    #[doc = "Bit 21 - RTTINC2 Alarm Enable"]
    #[inline(always)]
    pub fn inc2aen(&self) -> INC2AEN_R {
        INC2AEN_R::new(((self.bits >> 21) & 0x01) != 0)
    }
    #[doc = "Bit 22 - Trigger Event Alarm Enable"]
    #[inline(always)]
    pub fn evaen(&self) -> EVAEN_R {
        EVAEN_R::new(((self.bits >> 22) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 21 - RTTINC2 Alarm Enable"]
    #[inline(always)]
    pub fn inc2aen(&mut self) -> INC2AEN_W {
        INC2AEN_W { w: self }
    }
    #[doc = "Bit 22 - Trigger Event Alarm Enable"]
    #[inline(always)]
    pub fn evaen(&mut self) -> EVAEN_W {
        EVAEN_W { w: self }
    }
    #[doc = "Bit 24 - Real-Time Clock 1Hz Clock Selection"]
    #[inline(always)]
