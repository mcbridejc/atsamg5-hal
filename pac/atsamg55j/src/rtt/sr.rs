...
pub struct RTTINC2_R(crate::FieldReader<bool, bool>);
impl RTTINC2_R {
    pub(crate) fn new(bits: bool) -> Self {
        RTTINC2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTTINC2_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[inline(always)]
    pub fn rttinc2(&self) -> RTTINC2_R {
        RTTINC2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
}
