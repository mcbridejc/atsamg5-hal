...
pub enum VROFF_AW {
    #[doc = "0: No effect."]
    NO_EFFECT = 0,
    #[doc = "1: If KEY is correct, asserts the system reset signal and stops the voltage regulator."]
    STOP_VREG = 1,
}
...
impl<'a> VROFF_W<'a> {
    ...
    #[doc = "If KEY is correct, asserts the system reset signal and stops the voltage regulator."]
    #[inline(always)]
