...
pub enum SMSMPL_A {
    ...
    CSM = 1,
    #[doc = "2: Supply Monitor enables one SLCK period every 32 SLCK periods"]
    _32SLCK = 2,
    #[doc = "3: Supply Monitor enables one SLCK period every 256 SLCK periods"]
    _256SLCK = 3,
    #[doc = "4: Supply Monitor enables one SLCK period every 2,048 SLCK periods"]
    _2048SLCK = 4,
}
...
impl<'a> SMSMPL_W<'a> {
    ...
    #[doc = "Supply Monitor enables one SLCK period every 32 SLCK periods"]
    #[inline(always)]
    pub fn _32slck(self) -> &'a mut W {
        self.variant(SMSMPL_A::_32SLCK)
    }
    #[doc = "Supply Monitor enables one SLCK period every 256 SLCK periods"]
    #[inline(always)]
    pub fn _256slck(self) -> &'a mut W {
        self.variant(SMSMPL_A::_256SLCK)
    }
    #[doc = "Supply Monitor enables one SLCK period every 2,048 SLCK periods"]
    #[inline(always)]
