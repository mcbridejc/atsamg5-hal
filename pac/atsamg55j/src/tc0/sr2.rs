...
#[doc = "Field `ENDRX` reader - End of Receiver Transfer (cleared by writing TC_RCR or TC_RNCR)"]
...
#[doc = "Field `RXBUFF` reader - Reception Buffer Full (cleared by writing TC_RCR or TC_RNCR)"]
...
impl R {
    ...
    #[doc = "Bit 8 - End of Receiver Transfer (cleared by writing TC_RCR or TC_RNCR)"]
    #[inline(always)]
    pub fn endrx(&self) -> ENDRX_R {
        ENDRX_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bit 9 - Reception Buffer Full (cleared by writing TC_RCR or TC_RNCR)"]
    #[inline(always)]
