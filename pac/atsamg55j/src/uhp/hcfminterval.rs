...
pub struct FRAMEINTERVAL_R(crate::FieldReader<u16, u16>);
impl FRAMEINTERVAL_R {
    pub(crate) fn new(bits: u16) -> Self {
        FRAMEINTERVAL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAMEINTERVAL_R {
...
pub struct FRAMEINTERVAL_W<'a> {
    w: &'a mut W,
}
impl<'a> FRAMEINTERVAL_W<'a> {
...
impl R {
    ...
    #[inline(always)]
    pub fn frameinterval(&self) -> FRAMEINTERVAL_R {
        FRAMEINTERVAL_R::new((self.bits & 0x3fff) as u16)
    }
...
impl W {
    #[doc = "Bits 0:13 - Frame interval"]
    #[inline(always)]
    pub fn frameinterval(&mut self) -> FRAMEINTERVAL_W {
        FRAMEINTERVAL_W { w: self }
    }
    #[doc = "Bits 16:30 - Largest data packet"]
    #[inline(always)]
